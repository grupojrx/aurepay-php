...
class WithdrawalsApi
{
    ...
    {
        list($response) = $this->withdrawalsCreateWithHttpInfo($withdrawalCreate, $contentType);
        return $response;
    }
     ...
     */
    public function withdrawalsCreateAsync($withdrawalCreate, string $contentType = self::contentTypes['withdrawalsCreate'][0])
    {
        return $this->withdrawalsCreateAsyncWithHttpInfo($withdrawalCreate, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function withdrawalsCreateRequest($withdrawalCreate, string $contentType = self::contentTypes['withdrawalsCreate'][0])
    {

        // verify the required parameter 'withdrawalCreate' is set
        if ($withdrawalCreate === null || (is_array($withdrawalCreate) && count($withdrawalCreate) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $withdrawalCreate when calling withdrawalsCreate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($withdrawalCreate)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($withdrawalCreate));
            } else {
                $httpBody = $withdrawalCreate;
            }
    ...
    {
        list($response) = $this->withdrawalsGetWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation withdrawalsGetWithHttpInfo
     *
     * Consulta saque
     *
     * @param  string $id Identificador ULID do recurso (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function withdrawalsGetAsync($id, string $contentType = self::contentTypes['withdrawalsGet'][0])
    {
        return $this->withdrawalsGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation withdrawalsGetAsyncWithHttpInfo
     *
     * Consulta saque
     *
     * @param  string $id Identificador ULID do recurso (required)
    ...
    /**
     * Create request for operation 'withdrawalsGet'
     *
     * @param  string $id Identificador ULID do recurso (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['withdrawalsGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function withdrawalsGetRequest($id, string $contentType = self::contentTypes['withdrawalsGet'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling withdrawalsGet'
            );
        }


        $resourcePath = '/withdrawals/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation withdrawalsGetPayload
     *
     * Payload request/response do saque
     *
     * @param  string $id Identificador ULID do recurso (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['withdrawalsGetPayload'] to see the possible values for this operation
     *
     * @throws \AurePayGenerated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AurePayGenerated\Model\SuccessEnvelope|\AurePayGenerated\Model\ErrorBody
     */
    public function withdrawalsGetPayload($id, string $contentType = self::contentTypes['withdrawalsGetPayload'][0])
    {
        list($response) = $this->withdrawalsGetPayloadWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation withdrawalsGetPayloadWithHttpInfo
     *
     * Payload request/response do saque
     *
     * @param  string $id Identificador ULID do recurso (required)
     ...
     */
    public function withdrawalsGetPayloadWithHttpInfo($id, string $contentType = self::contentTypes['withdrawalsGetPayload'][0])
    {
        $request = $this->withdrawalsGetPayloadRequest($id, $contentType);
    ...
    /**
     * Operation withdrawalsGetPayloadAsync
     *
     * Payload request/response do saque
     *
     * @param  string $id Identificador ULID do recurso (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function withdrawalsGetPayloadAsync($id, string $contentType = self::contentTypes['withdrawalsGetPayload'][0])
    {
        return $this->withdrawalsGetPayloadAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation withdrawalsGetPayloadAsyncWithHttpInfo
     *
     * Payload request/response do saque
     *
     * @param  string $id Identificador ULID do recurso (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function withdrawalsGetPayloadAsyncWithHttpInfo($id, string $contentType = self::contentTypes['withdrawalsGetPayload'][0])
    {
        $returnType = '\AurePayGenerated\Model\SuccessEnvelope';
        $request = $this->withdrawalsGetPayloadRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'withdrawalsGetPayload'
     *
     * @param  string $id Identificador ULID do recurso (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['withdrawalsGetPayload'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function withdrawalsGetPayloadRequest($id, string $contentType = self::contentTypes['withdrawalsGetPayload'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling withdrawalsGetPayload'
            );
        }


        $resourcePath = '/withdrawals/{id}/payload';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->withdrawalsListWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation withdrawalsListWithHttpInfo
     *
     * Lista saques
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['withdrawalsList'] to see the possible values for this operation
    ...
    /**
     * Operation withdrawalsListAsync
     *
     * Lista saques
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['withdrawalsList'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function withdrawalsListAsync(string $contentType = self::contentTypes['withdrawalsList'][0])
    {
        return $this->withdrawalsListAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation withdrawalsListAsyncWithHttpInfo
     *
     * Lista saques
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['withdrawalsList'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'withdrawalsList'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['withdrawalsList'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function withdrawalsListRequest(string $contentType = self::contentTypes['withdrawalsList'][0])
    {
